...
use App\Exports\Admin\PackageExport;
...
{
    protected $exportClass = PackageExport::class;
    protected $commonData;
    private $mainRoute = 'admin.package_management.packages';
        ...
        return datatables()
            ...
            ->addColumn('vehicle_categories', function ($row) {
                ...
                foreach ($row->vehicleCategories as $vehicleCategory) {
                    ...
                    $list .= '<td>'.$row->totalEstimatedTime($vehicleCategory->id).' mins</td>';
                    $list .= '</tr>';
                }
                $list .= '</table>';
     ...
     */
    public function query(Package $model): \Illuminate\Database\Eloquent\Builder
    {
        return $model->query();
    }
    ...
    protected function getColumns(): array
    {
        return [
            ...
            ['data' => 'image', 'title' => 'Package Image', 'width' => '80px'],
            ['data' => 'name', 'title' => 'Package Name'],
    ...
    protected $printColumns = [
        ['data' => 'id', 'title' => 'ID#'],
        ['data' => 'image', 'title' => 'Package Image'],
        ['data' => 'name', 'title' => 'Package Name'],
        ['data' => 'description', 'title' => 'Description'],
        ['data' => 'services', 'title' => 'Services'],
        ['data' => 'vehicle_categories', 'title' => 'Vehicle Categories'],
