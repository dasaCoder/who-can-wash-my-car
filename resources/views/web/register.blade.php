                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="client" role="tabpanel" aria-labelledby="clientTab">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <button type="submit" class="thm-btn w-75 f-18">Generate OTP</button>
                                </div>
                            ...
                            <div class="tab-pane fade" id="proPartner" role="tabpanel" aria-labelledby="proPartnerTab">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <a href="otp-verification.html" type="submit" class="thm-btn w-75 f-18 text-center text-white">Generate OTP</a>
                                </div>
