<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
    ...
    <div class="card card-sidebar-mobile">
        <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.bank_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Bank Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.bank_management.banks.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.bank_management.banks.*') ? 'active' : '' }}">Banks</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.bank_management.bank_branches.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.bank_management.bank_branches.*') ? 'active' : '' }}">Branches</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.service_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Service Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.service_management.services.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.service_management.services.*') ? 'active' : '' }}">Services</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.package_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Package Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.package_management.packages.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.package_management.packages.*') ? 'active' : '' }}">Packages</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.subscription_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Subscription Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.subscription_management.subscription_packages.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.subscription_management.subscription_packages.*') ? 'active' : '' }}">Subscription Packages</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.subscription_management.subscription_plans.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.subscription_management.subscription_plans.*') ? 'active' : '' }}">Subscription Plans</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.web_content_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Web Content Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.web_content_management.home')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.home') ? 'active' : '' }}">Home</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.web_content_management.about_us')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.about_us') ? 'active' : '' }}">About Us</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.web_content_management.contact_details')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.contact_details') ? 'active' : '' }}">Contact Details</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.web_content_management.links')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.links') ? 'active' : '' }}">Manage Links</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.web_content_management.blogs.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.blogs.*') ? 'active' : '' }}">Blogs</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.web_content_management.faqs.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.web_content_management.faqs.*') ? 'active' : '' }}">Faqs</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.vehicle_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-truck"></i> <span>Vehicle Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.vehicle_management.vehicles.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.vehicle_management.vehicles.*') ? 'active' : '' }}">Vehicles</a>
                    </li>
                    <li class="nav-item-divider"></li>
                    <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.vehicle_management.category_master.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                        <a href="#" class="nav-link">Category Master</a>
                        <ul class="nav nav-group-sub">
                            <li class="nav-item"><a
                                    href="{{route('admin.vehicle_management.category_master.types.index')}}"
                                    class="nav-link {{ Request::routeIs('admin.vehicle_management.category_master.types.*') ? 'active' : '' }}">Types</a>
                            </li>
                            <li class="nav-item"><a
                                    href="{{route('admin.vehicle_management.category_master.makes.index')}}"
                                    class="nav-link {{ Request::routeIs('admin.vehicle_management.category_master.makes.*') ? 'active' : '' }}">Makes</a>
                            </li>
                            <li class="nav-item"><a
                                    href="{{route('admin.vehicle_management.category_master.models.index')}}"
                                    class="nav-link {{ Request::routeIs('admin.vehicle_management.category_master.models.*') ? 'active' : '' }}">Models</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.vehicle_management.attribute_master.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                        <a href="#" class="nav-link">Attribute Master</a>
                        <ul class="nav nav-group-sub">
                            <li class="nav-item"><a
                                    href="{{route('admin.vehicle_management.attribute_master.types.index')}}"
                                    class="nav-link {{ Request::routeIs('admin.vehicle_management.attribute_master.types.*') ? 'active' : '' }}">Types</a>
                            </li>
                            <li class="nav-item"><a
                                    href="{{route('admin.vehicle_management.attribute_master.attributes.index')}}"
                                    class="nav-link {{ Request::routeIs('admin.vehicle_management.attribute_master.attributes.*') ? 'active' : '' }}">Attributes</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.customer_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-users"></i> <span>Customer Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.customer_management.customers.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.customer_management.customers.*') ? 'active' : '' }}">Customers</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.customer_management.quotations.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.customer_management.quotations.*') ? 'active' : '' }}">Quotations</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.customer_management.inquiries.index')}}"
                                            class="nav-link {{ Request::routeIs('admin.customer_management.inquiries.*') ? 'active' : '' }}">Inquiries</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-item-submenu {{ Request::routeIs('admin.content_management.*') ? 'nav-item-expanded nav-item-open' : '' }}">
                <a href="#" class="nav-link"><i class="icon-file-text3"></i> <span>Content Management</span></a>
                <ul class="nav nav-group-sub" data-submenu-title="Sidebars">
                    <li class="nav-item"><a href="{{route('admin.content_management.home')}}"
                                            class="nav-link {{ Request::routeIs('admin.content_management.home') ? 'active' : '' }}">Home</a>
                    </li>
                    <li class="nav-item"><a href="{{route('admin.content_management.about_us')}}"
                                            class="nav-link {{ Request::routeIs('admin.content_management.about_us') ? 'active' : '' }}">About
                            Us</a></li>
                    <li class="nav-item"><a href="{{route('admin.content_management.contact_us')}}"
                                            class="nav-link {{ Request::routeIs('admin.content_management.contact_us') ? 'active' : '' }}">Contact
                            Us</a></li>
                </ul>
            </li>--}}
        </ul>
